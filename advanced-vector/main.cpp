...
void Test6() {
    ...
    }
    {
        ...
        assert(&*pos == &v[1]);
        assert(v[1].id == 1);
        /*std::cout << Obj::default_construction_throw_countdown << " ";
        std::cout << Obj::num_default_constructed << " ";
        std::cout << Obj::num_copied << " ";
        std::cout << Obj::num_moved << " ";
        std::cout << Obj::num_destroyed << " ";
        std::cout << Obj::num_constructed_with_id << " ";
        std::cout << Obj::num_constructed_with_id_and_name << " ";
        std::cout << Obj::num_assigned << " ";
